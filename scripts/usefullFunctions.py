from SystemSecurityPlans.models import *
import logging
...
def addControlsToGroup(group_name,controls):
    ...
    """
    from SystemSecurityPlans.models import prop, system_control
...
def changeRoll(old_role,new_role):
    from SystemSecurityPlans.models import system_control, user_role
...
def delUnusedRoles():
    from SystemSecurityPlans.models import user_role
