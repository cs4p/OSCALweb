...
class system_controlAdmin(admin.ModelAdmin):
    ...
    list_filter = ['control_responsible_roles','control_origination','nist_control__group_title','properties']
...
class nist_controlAdmin(admin.ModelAdmin):
    filter_horizontal = ['parameters','links','annotations']
...
@admin.register(models.nist_control_part)
class nist_control_partAdmin(admin.ModelAdmin):
    filter_horizontal = ['part_properties']
    list_filter = ['control','part_name']
...
class system_inventory_itemAdmin(admin.ModelAdmin):
    ...
    list_display = ['title', 'inventory_item_type', 'desc']
...
class inventory_item_typeAdmin(admin.ModelAdmin):
    ...
    list_display = ['inventory_item_type_name', 'use', 'desc', 'baseline_configuration']
...
class system_serviceAdmin(admin.ModelAdmin):
    list_display = ['title','short_name','desc']
...
class system_componentAdmin(admin.ModelAdmin):
    ...
    list_display = ['title','component_type', 'desc']
